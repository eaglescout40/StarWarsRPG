...
let setBkImg = function (side, name) {
  ...
  switch (name) {
    case "Yoda":
      imgName = side == "l" ? "yodaLeft.jpg" : "yodaRight.jpg";
      break;
    case "Darth Vader":
      imgName = side == "l" ? "vaderLeft.jpg" : "vader-right.jpg";
      break;
    case "Darth Maul":
      imgName = side == "l" ? "darthLeft.jpg" : "darthRight.jpg";
      break;
    case "Yoda":
      imgName = side == "l" ? "lukeLeft.jpg" : "lukeRight.jpg";
      break;
    default:
      break;
